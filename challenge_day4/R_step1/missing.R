...
# Set working directory to the repo root (relative to each user's home folder)
setwd("~/computational-thinking-week-group-6BestFriendsSittingInAHottub")
...
write(json_text, "challenge_day4/fulldata/data2.json")